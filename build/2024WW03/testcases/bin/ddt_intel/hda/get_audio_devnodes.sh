...
#
# ChangeLog:
#		1. 7/28/2015 -- by zelinx.deng@intel.com
#			a)Modified usage to fit intel device
#			b)
#
# Print out the hw id (i.e plughw:0,0) of all audio devices present on the board
...
cat <<-EOF >&2
        ...
        -d DEVICE_TYPE  audio device type like 'hdmi','analog' etc. If
...
do
  echo "plughw:${SOUND_CARDS[$((i*2))]},${SOUND_CARDS[$((1 + i*2))]}"
done
