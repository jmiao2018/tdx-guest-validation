...
#
#
# File:         LPSS_Check_sdhci_driver_is_loaded.sh
#
...
NUMBER=213
NAME="Check_sdhci_driver_is_loaded"
AUTHOR=""
STATUS="Ready"
TYPE="BAT"
COMPONENT="LPSS"

DESCRIPTION="Check_sdhci_driver_is_loaded"
OBJECTIVE=""
...
test_type[0]="2"
step_numero[0]="1"
step_cmd[0]=". ../../executables/LPSS_check_drivers_are_loaded.sh sdhci-acpi"
step_status[0]="0"
