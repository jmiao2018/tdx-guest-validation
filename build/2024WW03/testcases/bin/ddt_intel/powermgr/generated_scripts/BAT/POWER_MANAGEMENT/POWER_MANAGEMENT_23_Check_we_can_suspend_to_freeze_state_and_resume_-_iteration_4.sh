...
#
#
# File:         POWER_MANAGEMENT_23_Check_we_can_suspend_to_freeze_state_and_resume_-_iteration_4.sh
#
...
NUMBER=105
NAME="23 Check we can suspend to freeze state and resume - iteration 4"
AUTHOR=""
STATUS="Ready"
TYPE="BAT"
