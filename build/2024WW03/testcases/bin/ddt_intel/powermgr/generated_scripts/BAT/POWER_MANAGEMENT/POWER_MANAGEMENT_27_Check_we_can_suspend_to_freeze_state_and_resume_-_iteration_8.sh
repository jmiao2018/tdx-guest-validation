...
#
#
# File:         POWER_MANAGEMENT_27_Check_we_can_suspend_to_freeze_state_and_resume_-_iteration_8.sh
#
...
NUMBER=109
NAME="27 Check we can suspend to freeze state and resume - iteration 8"
AUTHOR=""
STATUS="Ready"
TYPE="BAT"
