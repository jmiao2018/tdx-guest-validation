...
#
#
# File:         POWER_MANAGEMENT_25_Check_we_can_suspend_to_freeze_state_and_resume_-_iteration_6.sh
#
...
NUMBER=107
NAME="25 Check we can suspend to freeze state and resume - iteration 6"
AUTHOR=""
STATUS="Ready"
TYPE="BAT"
