...
#
#
# File:         POWER_MANAGEMENT_24_Check_we_can_suspend_to_freeze_state_and_resume_-_iteration_5.sh
#
...
NUMBER=106
NAME="24 Check we can suspend to freeze state and resume - iteration 5"
AUTHOR=""
STATUS="Ready"
TYPE="BAT"
