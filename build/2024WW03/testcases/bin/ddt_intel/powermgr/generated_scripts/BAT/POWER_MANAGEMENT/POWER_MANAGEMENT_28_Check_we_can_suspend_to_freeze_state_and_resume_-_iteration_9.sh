...
#
#
# File:         POWER_MANAGEMENT_28_Check_we_can_suspend_to_freeze_state_and_resume_-_iteration_9.sh
#
...
NUMBER=110
NAME="28 Check we can suspend to freeze state and resume - iteration 9"
AUTHOR=""
STATUS="Ready"
TYPE="BAT"
