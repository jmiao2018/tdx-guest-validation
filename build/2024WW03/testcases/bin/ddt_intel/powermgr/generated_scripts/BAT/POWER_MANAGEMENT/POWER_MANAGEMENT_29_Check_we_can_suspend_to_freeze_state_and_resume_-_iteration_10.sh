...
#
#
# File:         POWER_MANAGEMENT_29_Check_we_can_suspend_to_freeze_state_and_resume_-_iteration_10.sh
#
...
NUMBER=111
NAME="29 Check we can suspend to freeze state and resume - iteration 10"
AUTHOR=""
STATUS="Ready"
TYPE="BAT"
