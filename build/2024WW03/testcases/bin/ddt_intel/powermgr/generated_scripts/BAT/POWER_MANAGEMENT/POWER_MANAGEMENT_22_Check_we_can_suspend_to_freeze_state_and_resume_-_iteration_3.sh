...
#
#
# File:         POWER_MANAGEMENT_22_Check_we_can_suspend_to_freeze_state_and_resume_-_iteration_3.sh
#
...
NUMBER=85
NAME="22 Check we can suspend to freeze state and resume - iteration 3"
AUTHOR=""
STATUS="Ready"
TYPE="BAT"
