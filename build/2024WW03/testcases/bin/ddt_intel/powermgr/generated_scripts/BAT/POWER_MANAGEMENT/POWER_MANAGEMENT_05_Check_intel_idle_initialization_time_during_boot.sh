...
#
#
# File:         POWER_MANAGEMENT_05_Check_intel_idle_initialization_time_during_boot.sh
#
...
NUMBER=73
NAME="05 Check intel_idle initialization time during boot"
AUTHOR=""
STATUS="Ready"
TYPE="BAT"
...
dmesg |grep -E 'initcall.*intel_idle_init' |grep -Po '(?<=after )[[:digit:]]* [^&]secs'

Commands return init times, e.g. 246 usecs
...
test_type[0]="2"
step_numero[0]="1"
step_cmd[0]="dmesg |grep -E \"initcall.*intel_idle_init\" |grep -Po \"(?<=after )[[:digit:]]*\""
step_status[0]=""
