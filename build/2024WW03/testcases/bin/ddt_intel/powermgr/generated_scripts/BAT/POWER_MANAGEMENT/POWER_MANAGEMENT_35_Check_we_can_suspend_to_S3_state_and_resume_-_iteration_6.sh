...
#
#
# File:         POWER_MANAGEMENT_35_Check_we_can_suspend_to_S3_state_and_resume_-_iteration_6.sh
#
...
NUMBER=90
NAME="35 Check we can suspend to S3 state and resume - iteration 6"
AUTHOR=""
STATUS="Ready"
TYPE="BAT"
...
test_type[0]="2"
step_numero[0]="1"
step_cmd[0]="sudo rtcwake -m on -s 60 & sudo pm-suspend"
step_status[0]=""
